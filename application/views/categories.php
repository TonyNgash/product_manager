                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><a href="<?php echo site_url(); ?>/mycontroller/category/<?php echo $row->cat_name; ?>"><?php echo $row->cat_name; ?></a><span class="badge btn-primary">0.0</span></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>                
                    </div>
